...
_magic_number = 10
_modified_time = 1427903191.083632
_enable_loop = True
_template_filename = u'/home/decause/.virtualenvs/decauseblog/lib/python2.7/site-packages/nikola/data/themes/bootstrap3/templates/base_helper.tmpl'
...
def render_late_load_js(context):
    ...
    try:
        ...
        if use_bundles:
            if use_cdn:
                __M_writer(u'            <script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>\n            <script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script>\n            <script src="/assets/js/all.js"></script>\n')
            else:
...
def render_html_stylesheets(context):
    ...
    try:
        ...
        if use_bundles:
            if use_cdn:
                __M_writer(u'            <link href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css" rel="stylesheet">\n            <link href="/assets/css/all.css" rel="stylesheet" type="text/css">\n')
            else:
